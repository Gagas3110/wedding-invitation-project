...
export function PersistentLeftBackdrop() {
  return (
    <aside 
      ...
      className="hidden lg:flex fixed top-0 left-0 bottom-0 w-[calc(100vw-480px)] xl:w-[calc(100vw-520px)] h-screen z-0 flex-col justify-end p-12 xl:p-16 overflow-hidden bg-cover bg-center bg-no-repeat select-none"
